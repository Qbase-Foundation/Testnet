/* src/config/qbase-config.h.  Generated from qbase-config.h.in by configure.  */
/* src/config/qbase-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef QBASE_CONFIG_H

#define QBASE_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Qbase Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Qbase Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/Qbase/issues"
